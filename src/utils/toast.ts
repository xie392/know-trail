...
import ToastNotify from "~/components/common/toast-notify";
...
export class Toast {
  ...
  static notify(message: string, options?: Partial<ToastOptions>) {
    toast.custom(
      (t) => createElement(ToastNotify, { t, message }, null),
      options,
    );
  }
